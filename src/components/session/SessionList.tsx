  ...
  return (
    <>
      {sessions.map((session: any) => (
        <article onClick={() => toggleSession(3)} className="group cursor-pointer select-none mt-5 px-8 sm:px-10 py-5 sm:py-4 rounded-lg text-gray-300 hover:text-gray-100 bg-gray-900 hover:bg-gray-800 transition duration-300">
